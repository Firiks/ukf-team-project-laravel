                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <form action="{{ route('pracovnik.workplaces.request.store', app()->getLocale()) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @include('frontend.pracovnik.workplaces._partials._form')
